...
const MODULES = [
  {
    id: '1', course: 'Frontend React', title: 'Introducción a React',
    lessons: 8, duration: '4h 30m', status: 'Publicado', progress: 100,
  },
  {
    id: '2', course: 'Frontend React', title: 'Hooks y Estado',
    lessons: 10, duration: '5h 20m', status: 'Publicado', progress: 78,
  },
  {
    id: '3', course: 'Backend Node.js', title: 'Express y Middlewares',
    lessons: 7, duration: '3h 45m', status: 'Publicado', progress: 55,
  },
  {
    id: '4', course: 'Backend Node.js', title: 'Autenticación JWT',
    lessons: 6, duration: '3h 10m', status: 'Borrador', progress: 20,
  },
  {
    id: '5', course: 'Arquitectura', title: 'Patrones de Diseño',
