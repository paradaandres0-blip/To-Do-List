...
/* Íconos flotantes decorativos — lado izquierdo */
...
export const Login = () => {
  ...
  const onSubmit = async (data: LoginFormInputs) => {
    ...
    if (data.email && data.password.length >= 6) {
      ...
      setLoginError('Contraseña mínimo 6 caracteres.');
    }
  };
    ...
    <div className="w-full min-h-full flex flex-col justify-center py-0 relative">
      ...
      <div className="mb-5">
        ...
        <p className="text-slate-500 text-xs leading-relaxed">
          Salud · Nutrición · Bienestar Mental
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-2.5">
        <button type="button"
          className="glass flex items-center justify-center gap-2 rounded-xl py-2 px-3 text-xs font-medium text-slate-300 hover:text-white transition-all duration-200">
